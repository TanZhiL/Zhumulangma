...
public class HorizontalCenterRecycleView extends RecyclerView {
    ...
    /**
     * 设置初始化时选中的位置,该方法必须在{@link HorizontalCenterRecycleView#setAdapter(Adapter) }之前调用
     *
    ...
    /**
     * 设置每次显示多少个item,该方法必须在{@link HorizontalCenterRecycleView#setAdapter(Adapter) }之前调用
     *
