package com.gykj.videotrimmer.features.compress;
...
public class VideoCompressor {
    ...
    public static class VideoCompressTask extends AsyncTask<String, Float, Boolean> {
        ...
        protected Boolean doInBackground(String... paths) {
            ...
            return VideoController.getInstance().convertVideo(paths[0], paths[1], mQuality, percent -> {
                if(isCancelled()){
                    VideoController.getInstance().setCancel(true);
                    return;
                }
