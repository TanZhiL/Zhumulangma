...
import com.gykj.zhumulangma.listen.databinding.ListenActivityDownloadAlbumBinding;
...
public class DownloadAlbumActivity extends BaseActivity<ListenActivityDownloadAlbumBinding> implements View.OnClickListener,
    ...
    public int onBindLayout() {
        return R.layout.listen_activity_download_album;
    }
    ...
    public void initData() {
        ...
        mBinding.tvTrackNum.setText(String.format(this.getResources().getString(R.string.ji), mAlbum.getTrackCount()));
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.tv_more) {
            ...
            RouteHelper.navigateTo(mRouter.build(Constants.Router.Listen.F_DOWNLOAD_SORT)
                    .withLong(KeyCode.Home.ALBUMID, mAlbumId));
        } else if (id == R.id.ll_delete) {
            RouteHelper.navigateTo(mRouter.build(Constants.Router.Listen.F_DOWNLOAD_DELETE)
                    .withLong(KeyCode.Home.ALBUMID, mAlbumId));
    ...
    public void onEvent(FragmentEvent event) {
        ...
        switch (event.getCode()) {
            ...
            case EventCode.Listen.DOWNLOAD_DELETE:
                ...
                mBinding.tvTrackNum.setText(String.format(this.getResources().getString(R.string.ji),
                        downloadTracks.size()));
