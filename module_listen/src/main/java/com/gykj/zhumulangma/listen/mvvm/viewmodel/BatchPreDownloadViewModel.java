 ...
 * <br/>Description:
 */
public class BatchPreDownloadViewModel extends BaseRefreshViewModel<ZhumulangmaModel, Track> {
    ...
    public BatchPreDownloadViewModel(@NonNull Application application, ZhumulangmaModel model) {
